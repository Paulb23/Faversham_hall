...
int SSL_Light_Raytrace(int x0, int y0, int x1, int y1, void *data, int(*func)(int, int, void *)) {
    int dx = abs(x1 - x0);
    int dy = abs(y1 - y0);
    int x = x0;
    int y = y0;
...
int SSL_Light_Raytrace_up(int x0, int y0, int x1, int y1, void *data, int(*func)(int, int, void *)) {
    int dx = abs(x1 - x0);
    int dy = abs(y1 - y0);
    int x = x0 ;
    int y = y0 + 16;
...
int SSL_Light_Raytrace_left(int x0, int y0, int x1, int y1, void *data, int(*func)(int, int, void *)) {
    int dx = abs(x1 - x0);
    int dy = abs(y1 - y0);
    int x = x0 + 16;
    int y = y0 + 16;
